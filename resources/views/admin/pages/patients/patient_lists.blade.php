				...
				<div class="card">
					<div class="card-header">
                        ...
                        <div class="btn-group ml-auto">
                            ...
                            <a href="{{ route('patients.create') }}" class="btn btn-primary text-white ml-auto float-right">
                                    ...
                                    @if($patients->count()>0)
                                        @foreach ($patients as $i=>$patient)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    {!! $patient->patient_gender==1? '<span class="badge-outline col-purple">Female</span>':'<span class="badge-outline col-cyan">Male</span>' !!}
                                                </td>
                                                <td>
                                                    {!! $patient->patient_status == 1? '<span class="badge badge-success">Active</span>':'<span class="badge badge-danger">Inactive</span>' !!}
                                                </td>
                                                <td>
                                                    <a type="button" id="view" data-id="{{$patient->id}}" class="view"><i class="far fa-eye text-success"></i></a>
                                                    <a href="{{ route('patients.edit',$patient->id)}}"><i class="fas fa-pencil-alt text-info"></i></a>
                                                    <a type="button" id="delete" data-id="{{$patient->id}}" class="delete"><i class="far fa-trash-alt text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#view', function(){
            var id = $(this).data('id');
            var url = '{{ route("patients.view",":id") }}';
