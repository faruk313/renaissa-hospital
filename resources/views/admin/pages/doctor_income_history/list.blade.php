...
@section('doctor_income_history','active')
@section('doctor_income_history_list','active')
                ...
                <div class="row py-2 mb-3" style="border: 1px dashed #333">
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="date" id="from_date" name="from_date" value="{{ old('from_date') }}" class="form-control">
                    </div>
                  </div>
                  <div class="col-md-2">
                    <div class="form-group">
                      <label for="to_date">To Date</label>
                      <input type="date" id="to_date" name="to_date" value="{{ old('to_date') }}" class="form-control" placeholder="dd-mm-yyyy">
                    </div>
                  </div>
                  {{-- <div class="col-md-2">
                    <div class="form-group">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-hover" id="example" style="width:100%;">
                    ...
                    <tbody id="custom_table">
                      @foreach($doctor_income_histories as $i=>$list)
                      <tr class="text-center">
                          <td>{{$i+1}}</td>
                          ...
                          <td>
                            @if($list->doctor->type == 3 || $list->doctor->type == 1)<span class="badge-outline col-red">not applicable! @else {{$list->doctor_payable_amount}} @endif
                          </td>
                      </tr>
                      @endforeach
                    </tbody>
...
<script>
  $(document).ready(function(){
    ...
    search_form.on('submit', function(event){
      event.preventDefault();
      var url = '{{ route("doctorIncomeCustomSearch.search") }}';
