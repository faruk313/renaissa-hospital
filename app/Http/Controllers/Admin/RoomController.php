...
class RoomController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.pages.rooms.rooms');
    }
    ...
    public function store(Request $request)
    {
        if(request('type')=='1'){
            ...
            return response()->json(['success' => 'New Pathology Room Added Successfully.']);
        }
        elseif(request('type')=='2'){
            ...
            Room::create($form_data);  
            return response()->json(['success' => 'New Doctor Chamber Added Successfully.']);
        }
