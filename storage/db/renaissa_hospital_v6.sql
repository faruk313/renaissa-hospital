...
--
-- Host: localhost:3306
-- Generation Time: Sep 22, 2020 at 11:17 PM
...
(46, '2020_09_23_033015_create_payments_table', 14);
...
INSERT INTO `payments` (`id`, `payment_date`, `prescription_ticket_id`, `paid_amount`, `due_amount`, `created_at`, `updated_at`) VALUES
(1, '2020-09-23', 4, 200, 85, '2020-09-22 22:43:49', '2020-09-22 22:43:49');
...
(1, '2020-09-23', 1, 1, 25, 16, 300, 0, 300, NULL, NULL),
(2, '2020-09-23', 2, 1, 5, 1, 300, 5, 285, '2020-09-22 22:40:16', '2020-09-22 22:40:16'),
(3, '2020-09-23', 3, 1, 5, 1, 300, 5, 285, '2020-09-22 22:43:20', '2020-09-22 22:43:20'),
(4, '2020-09-23', 4, 1, 5, 1, 300, 5, 285, '2020-09-22 22:43:49', '2020-09-22 22:43:49');
...
ALTER TABLE `payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `payments_prescription_ticket_id_foreign` (`prescription_ticket_id`);
...
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_prescription_ticket_id_foreign` FOREIGN KEY (`prescription_ticket_id`) REFERENCES `prescription_tickets` (`id`);
