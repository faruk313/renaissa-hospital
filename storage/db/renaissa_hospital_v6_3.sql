...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2020 at 02:46 PM
...
INSERT INTO `invoices` (`id`, `invoice_date`, `invoice_no`, `prescription_ticket_id`, `patient_test_id`, `patient_id`, `doctor_id`, `person_id`, `payable_amount`, `discount`, `total_amount`, `created_at`, `updated_at`) VALUES
(1, '2020-09-24', '1', 1, NULL, 1, 5, 1, 300, 10, 270, '2020-09-24 13:01:18', '2020-09-24 13:01:18');
...
(52, '2020_09_23_153222_create_invoices_table', 15),
(53, '2020_09_24_175039_create_patient_payments_table', 15),
(54, '2020_09_23_145942_create_patient_tests_table', 16);
...
(1, '2020-09-24', 1, 200, 70, '2020-09-24 13:01:18', '2020-09-24 13:01:18');
...
ALTER TABLE `invoices`
  ...
  ADD KEY `invoices_patient_test_id_foreign` (`patient_test_id`),
...
ALTER TABLE `patient_tests`
  ...
  ADD KEY `patient_tests_person_id_foreign` (`person_id`),
...
ALTER TABLE `invoices`
  ...
  ADD CONSTRAINT `invoices_patient_test_id_foreign` FOREIGN KEY (`patient_test_id`) REFERENCES `patient_tests` (`id`),
...
--
ALTER TABLE `patient_tests`
  ADD CONSTRAINT `patient_tests_doctor_id_foreign` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`),
  ADD CONSTRAINT `patient_tests_patient_id_foreign` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`),
  ADD CONSTRAINT `patient_tests_person_id_foreign` FOREIGN KEY (`person_id`) REFERENCES `ref_users` (`id`),
