...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2020 at 02:19 PM
...
(3, '2020-10-12', 1, 132, '2020-10-11 22:23:12', '2020-10-11 22:23:12'),
...
(5, 'doc1599472652', 2, 300, 300, 200, 200, NULL, 10, 'dr. abc xyz abc xyz', 'xyz1@gmail.com', '123', 'doctor_1599588050.png', 9, 28, '2001-09-07', 1, 'mbbs', 'dhaka', 'dhaka', 'cmc', 'doc', 'ctg', '2020-09-07', 1, 1, 'from 10am to 5pm', 1, '2020-09-07 09:57:32', '2020-09-09 07:52:26'),
...
(17, 'doc1599646537', 2, 500, 500, 300, 200, NULL, 10, 'Maj. Gen. Dr. H.R. Harun (Retd.)', NULL, NULL, 'doctor_1599646537.png', 51, 25, '1990-08-17', 1, 'MBBS, FCPS, FRCS (Edin), FRCS (Glasgow), FWHO (Urology), D. Uro. (London), Urologist', 'South Banasree, Khilgoan, Dhaka-1219', 'South Banasree, Khilgoan, Dhaka-1219', 'Dhaka Medical College', 'Pro.', 'Dhaka', '2020-09-09', 1, 1, 'available 12pm to 4pm', 1, '2020-09-09 10:15:37', '2020-09-09 10:27:52'),
...
CREATE TABLE `doctor_chambers` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `chamber_code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `chamber_note` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `chamber_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
...
INSERT INTO `doctor_payments` (`id`, `invoice_date`, `doctor_id`, `paid_amount`, `created_at`, `updated_at`) VALUES
(8, '2020-10-12', 5, 368, '2020-10-11 22:23:30', '2020-10-11 22:23:30'),
(9, '2020-10-12', 11, 30000, '2020-10-13 10:49:44', '2020-10-13 10:49:44');
...
--
-- Table structure for table `employee_rooms`
--

CREATE TABLE `employee_rooms` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `room_code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `room_note` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'aaa', 10, '2020-10-06', 1, '2020-10-05 20:18:41', '2020-10-05 20:18:49');
...
(49, '2020-10-12', 'RH201001', 24, NULL, 1, 5, 1, 300, 10, 270, '2020-10-11 22:12:38', '2020-10-11 22:12:38'),
(50, '2020-10-12', 'RH201002', NULL, 31, 1, 5, 1, 680, 0, 680, '2020-10-11 22:13:15', '2020-10-11 22:13:15'),
(51, '2020-10-12', 'RH201003', 25, NULL, 2, 11, 1, 500, 0, 500, '2020-10-11 22:15:51', '2020-10-11 22:15:51'),
(52, '2020-10-12', 'RH201004', NULL, 32, 2, 11, 1, 680, 0, 680, '2020-10-11 22:16:21', '2020-10-11 22:16:21'),
(53, '2020-10-12', 'RH201005', 26, NULL, 3, 10, 2, 300, 0, 300, '2020-10-11 22:18:56', '2020-10-11 22:18:56'),
(54, '2020-10-12', 'RH201006', NULL, 33, 3, 10, 3, 730, 0, 730, '2020-10-11 22:19:27', '2020-10-11 22:19:27'),
(55, '2020-10-12', 'RH201007', 27, NULL, 4, 17, 1, 500, 0, 500, '2020-10-11 22:20:38', '2020-10-11 22:20:38'),
(56, '2020-10-12', 'RH201008', NULL, 34, 4, 17, 3, 3314, 0, 3314, '2020-10-11 22:21:20', '2020-10-11 22:21:20'),
(57, '2020-10-12', 'RH201009', 28, NULL, 1, 10, 1, 300, 0, 300, '2020-10-12 13:13:05', '2020-10-12 13:13:05');
...
(50, '2020_09_23_010114_create_prescription_tickets_table', 14),
...
(57, '2020_09_23_153222_create_invoices_table', 17),
...
(66, '2020_09_28_034741_create_doctor_payments_table', 23),
(67, '2020_10_12_145939_create_doctor_chambers_table', 24),
...
--
-- Table structure for table `pathology_rooms`
--

CREATE TABLE `pathology_rooms` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `room_code` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `room_note` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `room_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
...
(41, '2020-10-12', 49, 270, 0, '2020-10-11 22:12:38', '2020-10-12 11:34:52'),
...
(46, '2020-10-12', 54, 500, 230, '2020-10-11 22:19:27', '2020-10-11 22:19:27'),
(47, '2020-10-12', 55, 500, 0, '2020-10-11 22:20:38', '2020-10-12 10:52:52'),
(48, '2020-10-12', 56, 2000, 1314, '2020-10-11 22:21:20', '2020-10-11 22:21:20'),
(49, '2020-10-12', 57, 200, 100, '2020-10-12 13:13:05', '2020-10-12 13:13:05');
...
(31, '2020-10-12', 1, 5, 1, '2020-10-11 22:13:15', '2020-10-11 22:13:15'),
(32, '2020-10-12', 2, 11, 1, '2020-10-11 22:16:20', '2020-10-11 22:16:20'),
(33, '2020-10-12', 3, 10, 3, '2020-10-11 22:19:27', '2020-10-11 22:19:27'),
(34, '2020-10-12', 4, 17, 3, '2020-10-11 22:21:20', '2020-10-11 22:21:20');
...
(24, '2020-10-12', 1, 1, 5, 1, 300, 10, 270, '2020-10-11 22:12:38', '2020-10-11 22:12:38'),
(25, '2020-10-12', 1, 2, 11, 1, 500, 0, 500, '2020-10-11 22:15:51', '2020-10-11 22:15:51'),
(26, '2020-10-12', 1, 3, 10, 2, 300, 0, 300, '2020-10-11 22:18:56', '2020-10-11 22:18:56'),
(27, '2020-10-12', 1, 4, 17, 1, 500, 0, 500, '2020-10-11 22:20:38', '2020-10-11 22:20:38'),
(28, '2020-10-12', 2, 1, 10, 1, 300, 0, 300, '2020-10-12 13:13:04', '2020-10-12 13:13:04');
...
ALTER TABLE `doctor_chambers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `doctor_chambers_user_id_foreign` (`user_id`);
...
--
-- Indexes for table `employee_rooms`
--
ALTER TABLE `employee_rooms`
  ADD PRIMARY KEY (`id`),
  ADD KEY `employee_rooms_user_id_foreign` (`user_id`);
...
--
-- Indexes for table `pathology_rooms`
--
ALTER TABLE `pathology_rooms`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pathology_rooms_user_id_foreign` (`user_id`);
...
--
-- AUTO_INCREMENT for table `employee_rooms`
--
ALTER TABLE `employee_rooms`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `pathology_rooms`
--
ALTER TABLE `pathology_rooms`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `doctor_chambers`
  ADD CONSTRAINT `doctor_chambers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
--
-- Constraints for table `employee_rooms`
--
ALTER TABLE `employee_rooms`
  ADD CONSTRAINT `employee_rooms_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
--
-- Constraints for table `pathology_rooms`
--
ALTER TABLE `pathology_rooms`
  ADD CONSTRAINT `pathology_rooms_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
