...
--
-- Host: localhost:3306
-- Generation Time: Oct 05, 2020 at 07:59 PM
...
(1, '2020-10-05', '1', NULL, 10, 2, 350, 18, '2020-10-05 17:34:18', '2020-10-05 17:34:18');
...
CREATE TABLE `doctors` (
  ...
  `prescription_fees` int(11) NOT NULL DEFAULT '0',
  `prescription_payable` int(11) NOT NULL DEFAULT '0',
  `report_fees` int(11) NOT NULL DEFAULT '0',
  `report_payable` int(11) NOT NULL DEFAULT '0',
  `salary_or_contract_fees` int(11) NOT NULL DEFAULT '0',
  ...
  `to_time` time NOT NULL DEFAULT '18:00:00',
  `from_time` time NOT NULL DEFAULT '21:00:00',
...
INSERT INTO `doctors` (`id`, `doctor_id`, `type`, `prescription_fees`, `prescription_payable`, `report_fees`, `report_payable`, `salary_or_contract_fees`, `test_commission`, `name`, `email`, `mobile`, `photo`, `department_id`, `chamber_id`, `dob`, `gender`, `degrees`, `mailing_address`, `permanent_address`, `present_institute`, `institute_designation`, `institute_address`, `joining_date`, `status`, `to_time`, `from_time`, `to_date`, `from_date`, `leave_or_present_status`, `leave_or_present_note`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 'D00017635', 4, 0, 0, 0, 0, 0, 0, 'dfzgd', NULL, NULL, '', 0, 0, NULL, 1, 'Zfdg', NULL, NULL, NULL, NULL, NULL, NULL, 1, '18:00:00', '21:00:00', NULL, NULL, 1, NULL, 1, '2020-10-05 07:02:03', '2020-10-05 07:02:03'),
(2, 'D033486167', 4, 0, 0, 0, 0, 0, 0, 'asdsd sadas', NULL, NULL, '', 0, 0, NULL, 1, 'Asdsadsad', NULL, NULL, NULL, NULL, NULL, NULL, 1, '23:15:00', '20:15:00', NULL, NULL, 1, NULL, 1, '2020-10-05 07:05:11', '2020-10-05 07:05:11'),
(3, 'D082042964', 4, 0, 0, 0, 0, 0, 0, 'jpjp', NULL, NULL, '', 0, 0, NULL, 1, 'Pokkopjo', NULL, NULL, NULL, NULL, NULL, NULL, 1, '18:00:00', '21:00:00', NULL, NULL, 1, NULL, 1, '2020-10-05 07:26:28', '2020-10-05 07:26:28'),
(4, 'D064857204', 1, 444, 0, 333, 0, 33333, 1, 'Kln', NULL, '2222', '', 9, 28, '1990-08-17', 1, 'Koko', 'jnjnj', 'knn', 'gggg', 'hhhh', 'jjjj', '2020-10-05', 1, '23:30:00', '15:30:00', NULL, NULL, 1, 'off days: sat', 1, '2020-10-05 07:28:02', '2020-10-05 07:28:02');
...
CREATE TABLE `doctor_income_histories` (
  ...
  `doctor_payable_amount` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `doctor_income_histories` (`id`, `invoice_date`, `invoice_no`, `prescription_ticket_id`, `patient_test_invoice_id`, `doctor_id`, `doctor_income_amount`, `doctor_payable_amount`, `created_at`, `updated_at`) VALUES
(1, '2020-10-05', '1', NULL, 10, 2, 350, 0, '2020-10-05 17:34:18', '2020-10-05 17:34:18');
...
(1, 'Doctor Payment', 1000, '2020-09-06', 1, NULL, '2020-10-05 19:28:42'),
(2, 'doctor payment', 1000, '2020-10-06', 1, '2020-10-05 19:21:36', '2020-10-05 19:21:36'),
(3, 'Doctor salary', 20000, '2020-10-06', 1, '2020-10-05 19:33:45', '2020-10-05 19:39:29'),
(4, 'Employee Salary', 20000, '2020-10-02', 1, '2020-10-05 19:37:42', '2020-10-05 19:40:04'),
(5, 'abc', 131, '2020-10-04', 1, '2020-10-05 19:50:19', '2020-10-05 19:50:19'),
(6, 'xyz', 100000000, '2020-10-06', 1, '2020-10-05 19:51:38', '2020-10-05 19:58:37'),
(7, 'doctor paid', 30000, '2020-10-06', 1, '2020-10-05 19:52:02', '2020-10-05 19:58:25'),
(8, 'employee payment', 200000, '2020-10-06', 1, '2020-10-05 19:52:26', '2020-10-05 19:58:10'),
(9, 'purchase', 40000, '2020-10-06', 1, '2020-10-05 19:54:16', '2020-10-05 19:57:52'),
(10, 'broker paid', 20000, '2020-10-06', 1, '2020-10-05 19:54:52', '2020-10-05 19:57:39'),
(11, 'abc xyz', 100000, '2020-10-06', 1, '2020-10-05 19:55:02', '2020-10-05 19:57:21');
...
(1, '2020-10-05', '1', NULL, 10, 2, 2, 2, 350, 0, 350, '2020-10-05 17:34:18', '2020-10-05 17:34:18');
...
(55, '2020_09_23_136019_create_patient_test_invoices_table', 16),
(56, '2020_09_23_145942_create_patient_tests_table', 16),
(58, '2020_09_28_034741_create_doctor_payments_table', 18),
(59, '2020_09_29_011146_create_doctor_income_histories_table', 18),
(60, '2020_09_29_044901_create_broker_income_histories_table', 19),
(61, '2020_09_29_045112_create_broker_payments_table', 19),
(63, '2020_09_23_010114_create_prescription_tickets_table', 20),
(65, '2020_09_23_153222_create_invoices_table', 21),
(66, '2020_09_24_175039_create_patient_payments_table', 21),
(69, '2020_09_06_193624_create_doctors_table', 22),
(70, '2020_10_05_235625_create_expenses_table', 23);
...
(1, '2020-10-05', 1, 350, 0, '2020-10-05 17:34:18', '2020-10-05 17:34:18');
...
(23, '2020-09-29', 9, 1, '2020-10-10', 350, 0, 350, '2020-09-29 00:23:00', '2020-09-29 00:23:00'),
(24, '2020-09-29', 9, 2, '2020-10-10', 180, 0, 180, '2020-09-29 00:23:00', '2020-09-29 00:23:00'),
(25, '2020-09-29', 9, 3, '2020-10-10', 150, 0, 150, '2020-09-29 00:23:00', '2020-09-29 00:23:00'),
(26, '2020-10-05', 10, 1, '2020-10-11', 350, 0, 350, '2020-10-05 17:34:18', '2020-10-05 17:34:18');
...
(9, '2020-09-29', 1, 5, 2, '2020-09-29 00:23:00', '2020-09-29 00:23:00'),
(10, '2020-10-05', 2, 2, 2, '2020-10-05 17:34:18', '2020-10-05 17:34:18');
...
INSERT INTO `prescription_tickets` (`id`, `ticket_date`, `ticket_no`, `serial_no`, `serial_time`, `patient_id`, `doctor_id`, `person_id`, `doctor_fees`, `discount`, `total_amount`, `created_at`, `updated_at`) VALUES
(1, '2020-10-15', 'T123133123', 11, '16:59:00', 35, 26, 6, 800, 90, 900, '2020-10-29 07:47:57', NULL);
...
--
ALTER TABLE `patient_tests`
  ADD CONSTRAINT `patient_tests_patient_test_invoice_id_foreign` FOREIGN KEY (`patient_test_invoice_id`) REFERENCES `patient_test_invoices` (`id`),
  ADD CONSTRAINT `patient_tests_test_id_foreign` FOREIGN KEY (`test_id`) REFERENCES `pathology_tests` (`id`);
