...
<?php $__env->startSection('broker_income_history','active'); ?>
<?php $__env->startSection('broker_income_history_list','active'); ?>
                ...
                <div class="row py-2 mb-3" style="border: 1px dashed #333">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" id="broker_name" name="broker_name" value="<?php echo e(old('broker_name')); ?>" class="form-control" placeholder="-----">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-hover" id="example" style="width:100%;">
                    ...
                    <tbody id="custom_table">
                      <?php $__currentLoopData = $broker_income_histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr class="text-center">
                          <td><?php echo e($i+1); ?></td>
                          <td><?php echo e($list->invoice_date); ?></td>
                          <td><?php echo e($list->invoice_no); ?></td>
                          <td><?php echo e($list->broker->ref_user_name); ?></td>
                          <td>
                          ...
                          <td><?php echo e($list->broker_income_amount); ?></td>
                          <td><?php echo e($list->broker_payable_amount); ?></td>
                      </tr>
...
<script>
  $(document).ready(function(){
    ...
    $('#broker_name').on('keyup',function(){
      ...
      var action_url = "<?php echo e(route('customSearch.brokerSearch')); ?>";
      var value=$(this).val();
      if(value.length >= '2'){
        $.ajax({
          type : 'get',
    ...
    search_form.on('submit', function(event){
      event.preventDefault();
      var url = '<?php echo e(route("brokerIncomeCustomSearch.search")); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital\resources\views/admin/pages/broker_income_history/list.blade.php ENDPATH**/ ?>