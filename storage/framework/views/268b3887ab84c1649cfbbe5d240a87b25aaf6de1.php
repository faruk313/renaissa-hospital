...
<html lang="en">
  <head>
    ...
    <title>Renaissa Hospital Admin Panel :: Login</title>
    <!-- General CSS Files -->
            ...
            <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              <div class="card card-primary">
                <div class="card-header text-center">
                  <h4>RENAISSA HOSPITAL &nbsp;<small>Admin Panel</small></h4>
                </div>
                <div class="card-body">
...
<?php /**PATH C:\laragon\www\renaissa-hospital3\resources\views/auth/login.blade.php ENDPATH**/ ?>