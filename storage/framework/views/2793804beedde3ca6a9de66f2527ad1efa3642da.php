				...
				<div class="card">
					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-striped table-hover table-condensed" id="test_table" style="width: 100%">
								<thead>
                            ...
                            <div class="col-md-6">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="badge badge-primary badge-pill">`+test.doctor_discount+` %</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        $(document).on('click', '#edit', function(){
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    $('#edit_form #doctor_discount').val(test.doctor_discount)
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hospital-renaissa\resources\views/admin/pages/pathology_tests/pathology_test_lists.blade.php ENDPATH**/ ?>