<?php $__env->startSection('title','Doctor Departments'); ?>
<?php $__env->startSection('departments','active'); ?>
<?php $__env->startSection('doctor_departments','active'); ?>
						...
						<div class="table-responsive">
							<table class="table table-striped table-hover" id="example" style="width: 100%">
								...
								<tbody class="text-center">
                                    <?php if($doctor_departments->count()>0): ?>
                                        <?php $__currentLoopData = $doctor_departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="text-center">
                                                <td><?php echo e($i+1); ?></td>
                                                <td><?php echo e($department->department_name); ?></td>
                                                <td><?php echo e($department->department_note); ?></td>
                                                <td>
                                                    <?php echo $department->department_status == 1? '<span class="badge badge-success">Active</span>':'<span class="badge badge-danger">Inactive</span>'; ?>
                                                ...
                                                <td>
                                                    <a type="button" id="show_btn" data-id="<?php echo e($department->id); ?>" class="show"><i class="far fa-eye text-success"></i></a>
                                                    <a type="button" id="edit_btn" data-id="<?php echo e($department->id); ?>" class="edit"><i class="fas fa-pencil-alt text-info"></i></a>
                                                    <a type="button" id="delete_btn" data-id="<?php echo e($department->id); ?>" class="delete"><i class="far fa-trash-alt text-danger"></i></a>
                                                </td>
                                            </tr>
...
<div class="modal fade" id="add_modal" tabindex="-1" role="dialog" aria-labelledby="formModal" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="add_form" method="POST" action="<?php echo e(route('doctorDepartments.store')); ?>">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '.edit', function(){
            ...
            var edit_url = '<?php echo e(route("doctorDepartments.edit",":edit_id")); ?>';
            ...
            $.ajax({
                ...
                {
                    var update_url = '<?php echo e(route("doctorDepartments.update",":update_id")); ?>';
        ...
        edit_form.on('submit', function(event){
            ...
            update_url = '<?php echo e(route("doctorDepartments.update",":update_id")); ?>';
        ...
        $('#ok_button').click(function(){
            ...
            var del_url = '<?php echo e(route("doctorDepartments.destroy",":del_id")); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital3\resources\views/admin/pages/departments/doctor_departments.blade.php ENDPATH**/ ?>