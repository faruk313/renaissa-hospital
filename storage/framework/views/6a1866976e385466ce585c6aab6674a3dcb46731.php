<?php $__env->startSection('title','Patient Test Invoice View'); ?>
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="invoice-print" id="testInvoicePrintView">
                <div class="row" id="print_header" style="border-bottom: 1px solid #6c757d;">
                    ...
                    <div class="col-4">
                        <div style="margin-top: 0px; border:1px dashed #222; padding:10px; text-align:center;">
                            <h6>Bill</h6>
                            <p style="margin:0px;">Invoice No: <strong>#<?php echo e($test_invoice->invoice_no); ?></strong></p>
                            <p style="margin:0px;">Date: <strong><?php echo e($test_invoice->invoice_date); ?></strong></p>
                        </div>
                    </div>
                ...
                <div class="row" id="patient_info" style="border-bottom: 1px solid #6c757d; margin-top:10px">
                    <div class="col-6">
                        <p class="clearfix">
                            ...
                            <span style="width:60%">
                                <span style="float:right;" id="patient_id"><?php echo e($test_invoice->patient->patient_id); ?></span>
                            </span>
                        </p>
                        <p class="clearfix">
                            ...
                            <span style="font-weight:700; width:4%">:</span>
                            <span style="width:60%">
                                <span style="float:right;" id="patient_name"><?php echo e($test_invoice->patient->patient_name); ?></span>
                            </span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="clearfix">
                            ...
                            <span style="font-weight:700; width:4%">:</span>
                            <span style="width:60%">
                                <span style="float:right;" id="patient_gender_age"><?php echo e(($test_invoice->patient->patient_gender==1?'Male':'Female').'/'.$test_invoice->patient->patient_age); ?></span>
                            </span>
                        </p>
                        <p class="clearfix">
                            ...
                            <span style="font-weight:700; width:4%">:</span>
                            <span style="width:60%">
                                <span style="float:right;" id="contact_number"><?php echo e($test_invoice->patient->patient_mobile); ?></span>
                            </span>
                        </p>
                    </div>
                    <div class="col-12" style="margin-top:0">
                        <p class="clearfix">
                            ...
                            <span style="width:82%">
                                <span style="float:left; margin-left:10px" id="ref_doctor"><?php echo e($test_invoice->doctor->name.', '.$test_invoice->doctor->degrees); ?></span>
                            </span>
                        </p>
                    </div>
                </div>    
                <div class="row" id="test_list">
                    <div class="col-12">
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $patient_tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="text-center">
                                <td><?php echo e($i+1); ?></td>
                                <td><?php echo e($test->pathologyTest->test_name); ?></td>
                                <td>22</td>
                                <td><?php echo e($test->test_price); ?></td>
                                <td><?php echo e($test->test_discount); ?></td>
                                <td><?php echo e($test->test_net_amount); ?></td>
                            </tr>
                ...
                <div class="row" id="bill_info">
                    ...
                    <div class="col-5 text-right">
                        <p class="" style="border-top:1px solid #222; padding:5px 0">
                            ...
                            <span style="width:30%">
                                <span style="float:right;" id="total"><?php echo e($test_invoice->total_amount); ?></span>
                            </span>
                        </p>
                        <p class="" style="border-top:1px solid #222; padding:5px 0">
                            <span style="width:70%">
                            ...
                            <span style="width:30%">
                                <span style="float:right;" id="discount"><?php echo e($discount); ?></span>
                            </span>
                        </p>
                        <p class="" style="border-top:1px solid #222; padding:5px 0">
                            <span style="width:70%">
                            ...
                            <span style="width:30%">
                                <span style="float:right;" id="net_total"><?php echo e($net_amount); ?></span>
                            </span>
                        </p>
                        <p class="" style="border-top:1px solid #222; padding:5px 0">
                            <span style="width:70%">
                            ...
                            <span style="width:30%">
                                <span style="float:right;" id="paid_amount"><?php echo e($patient_payments->sum('paid_amount')); ?></span>
                            </span>
                        </p>
                        <p class="" style="border-top:1px solid #222; padding:5px 0">
                            <span style="width:70%">
                            ...
                            <span style="width:30%">
                                <span style="float:right;" id="due_amount"><?php echo e($patient_payments->sum('due_amount')); ?></span>
                            </span>
                        </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p id="amountInWord" style="font-weight:700; padding:0; margin:3px 0; text-align:center;">In Words : <strong><?php echo e(takaInWord($patient_payments->sum('paid_amount'))); ?></strong></p>
                    </div>
                </div>
                <div class="row" id="print_footer">
                    <div class="col-6">
                        ...
                        <p id="billStatus" style="border:1px dashed #6c757d; padding:3px; width:160px; font-weight:700">
                            Bill Status : <?php echo e($patient_payments->sum('due_amount') == 0 ? 'Paid' : 'Due'); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital\resources\views/admin/pages/patient_tests/show.blade.php ENDPATH**/ ?>