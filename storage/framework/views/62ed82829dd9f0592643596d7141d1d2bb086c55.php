<?php $__env->startSection('title','Patient Prescription Ticket View'); ?>
<?php $__env->startSection('prescription_ticket','active'); ?>
    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="invoice-print-button">
                ...
                <a href="#" id="prescription_ticket_print" class="btn btn-warning text-white float-right"><i class="fas fa-print-left"></i>Print</a>
            </div>
        </div>
        <div class="row">
                ...
                <div class="row" id="print_header" style="border-bottom: 1px solid #6c757d;">
                    ...
                    <div class="col-4">
                        <div class="ticket_box">
                            <h6>Ticket</h6>
                            <p class="mr-zero">Invoice No: <strong>#<?php echo e($ticket_invoice->invoice_no); ?></strong></p>
                            <p class="mr-zero">Date: <strong><?php echo e($ticket_invoice->invoice_date); ?></strong></p>
                        </div>
                    </div>
                ...
                <div class="row" id="patient_info" style="border-bottom: 1px solid #6c757d; margin-top:10px">
                    <div class="col-6">
                        <p class="clearfix">
                            ...
                            <span style="width:60%">
                                <span style="float:right;" id="patient_id"><?php echo e($ticket_invoice->patient->patient_id); ?></span>
                            </span>
                        </p>
                        <p class="clearfix">
                            ...
                            <span style="font-weight:700; width:4%">:</span>
                            <span style="width:60%">
                                <span style="float:right;" id="patient_name"><?php echo e($ticket_invoice->patient->patient_name); ?></span>
                            </span>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="clearfix">
                            ...
                            <span style="font-weight:700; width:4%">:</span>
                            <span style="width:60%">
                                <span style="float:right;" id="patient_gender_age"><?php echo e(($ticket_invoice->patient->patient_gender==1?'Male':'Female').'/'.$ticket_invoice->patient->patient_age); ?></span>
                            </span>
                        </p>
                        <p class="clearfix">
                            ...
                            <span style="font-weight:700; width:4%">:</span>
                            <span style="width:60%">
                                <span style="float:right;" id="contact_number"><?php echo e($ticket_invoice->patient->patient_mobile); ?></span>
                            </span>
                        </p>
                    </div>
                    <div class="col-12" style="margin-top:0">
                        <p class="clearfix">
                            ...
                            <span style="width:82%">
                                <span style="float:left;" id="ref_doctor"><?php echo e($ticket_invoice->doctor->name.', '.$ticket_invoice->doctor->degrees); ?></span>
                            </span>
                        </p>
                    </div>
                </div>    
                    ...
                    <div class="col-12">
                        <table class="table">
                            ...
                            <tr class="text-center">
                                ...
                                <td><?php echo e($ticket_invoice->doctor->chamber_id); ?></td>
                                <td><?php echo e($ticket_invoice->prescriptonTicket->serial_no); ?></td>
                                
                                <td><?php echo e($ticket_invoice->doctor->prescription_fees); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-4" style="margin-right:0px; padding-right:0px;">
                                <p class="" style="margin-bottom:0px; border-top:1px solid #222; border-bottom:1px solid #222; padding-top:5px; padding-bottom:17px; padding-right:15px;">
                                    ...
                                    <span style="width:30%">
                                        <span style="float:right;" id="total"><?php echo e($total_amount); ?></span>
                                    </span>
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-4" style="margin-right:0px; padding-right:0px;">
                                <p class="" style="border-bottom:1px solid #222; padding-top:5px; padding-bottom:17px; padding-right:15px;">
                                    ...
                                    <span style="width:30%">
                                        <span style="float:right;" id="total"><?php echo e($patient_payments->sum('paid_amount')); ?></span>
                                    </span>
                                </p>
                            </div>
                            <div class="col-4" style="margin-left:0px; padding-left:0px;">
                                <p class="" style="border-bottom:1px solid #222; padding-top:5px; padding-bottom:17px; padding-left:17px; padding-right:0px;">
                                    ...
                                    <span style="width:30%">
                                        <span style="float:right;" id="discount">
                                            <?php echo e($patient_payments->sum('due_amount')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital\resources\views/admin/pages/prescription_ticket/show.blade.php ENDPATH**/ ?>