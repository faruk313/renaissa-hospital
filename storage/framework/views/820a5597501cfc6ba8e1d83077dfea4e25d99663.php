<?php $__env->startSection('title','Doctor Lists'); ?>
<?php $__env->startSection('doctors','active'); ?>
<?php $__env->startSection('doctors_list','active'); ?>
				...
				<div class="card">
					<div class="card-header">
                        ...
                        <div class="btn-group ml-auto">
                            ...
                            <a type="button" href="<?php echo e(route('doctors.create')); ?>" class="btn btn-primary text-white ml-auto float-right">
							...
							<table class="table table-striped table-hover" id="example" style="width: 100%">
								...
								<tbody class="text-center">
                                    <?php if($doctors->count()>0): ?>
                                        ...
                                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $i=  $i+1;
                                                $type = $doctor->type;
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <td><?php echo e($doctor->degrees); ?></td>
                                                <td>
                                                    <?php echo $type; ?>

                                                </td>
                                                <td>
                                                    <?php echo $leave_or_present_status; ?>

                                                </td>
                                                <td><?php echo e($doctor->leave_or_present_note); ?></td>
                                                <td>
                                                    <a href="<?php echo e(route('doctors.show',$doctor->id)); ?>" class="view"><i class="far fa-eye text-success"></i></a>
                                                    <a type="button" id="edit" data-id="<?php echo e($doctor->id); ?>" class="edit"><i class="fas fa-pencil-alt text-info"></i></a>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#edit', function(){
            var id = $(this).data('id');
            var url = '<?php echo e(route("doctors.edit",":id")); ?>';
        ...
        $(document).on('click', '#leavePresent', function(){
            var id = $(this).data('id');
            var url = '<?php echo e(route("doctors.leavePresent",":id")); ?>';
            url = url.replace(':id',id);
            
            var update_url = '<?php echo e(route("doctors.updateLeavePresent",":id")); ?>';
        ...
        //     var update_url = '<?php echo e(route("doctors.updateLeavePresent",":update_id")); ?>';
        ...
        $(document).on('click', '#delete', function(){
            ...
            var id = $(this).data('id');
            var url = '<?php echo e(route("doctors.destroy",":id")); ?>';
            url = url.replace(':id',id);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital\resources\views/admin/pages/doctors/doctor_lists.blade.php ENDPATH**/ ?>