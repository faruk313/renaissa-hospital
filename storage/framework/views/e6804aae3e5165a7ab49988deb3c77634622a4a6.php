<?php $__env->startSection('title','Prescription Tickets'); ?>
<?php $__env->startSection('prescription_ticket','active'); ?>
<?php $__env->startSection('prescription_ticket_list','active'); ?>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="btn-group ml-auto">
              ...
              <a href="<?php echo e(route('prescriptionTicket.create')); ?>" class="btn btn-primary text-white"><i class="fas fa-plus mr-2"></i>Create</a>
            </div>
          </div>
          <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-striped table-hover" id="example" style="width:100%;">
                  ...
                  <tbody id="custom_table">
                    ...
                    <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr class="text-center">
                        <td><?php echo e($i+1); ?></td>
                        <td><?php echo e($list->invoice_date); ?></td>
                        <td><?php echo e($list->invoice_no); ?></td>
                        <td><?php echo e($list->patient->patient_name); ?></td>
                        <td><?php echo e($list->prescriptonTicket->serial_no); ?></td>
                        ...
                        <td><?php echo e($list->person_id); ?></td>
                        <td class="actions">
                          <a href="<?php echo e(route('prescriptionTicket.view', $list->id)); ?>"><i class="fas fa-print text-danger"></i></a>
                          <a href="<?php echo e(route('prescriptionTicket.view', $list->id)); ?>"><i class="fas fa-eye text-info"></i></a>
                        </td>
                      </tr>
...
<script>
  $(document).ready(function(){
    ...
    search_form.on('submit', function(event){
      ...
      var url = '<?php echo e(route("prescriptionCustomSearch.search")); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital\resources\views/admin/pages/prescription_ticket/list.blade.php ENDPATH**/ ?>