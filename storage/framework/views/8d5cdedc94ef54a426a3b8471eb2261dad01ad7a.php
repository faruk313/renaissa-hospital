<?php $__env->startSection('title','Prescription Ticket Add'); ?>
<?php $__env->startSection('prescription_ticket','active'); ?>
<?php $__env->startSection('prescription_ticket_create','active'); ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="btn-group ml-auto">
                            ...
                            <a href="<?php echo e(route('prescriptionTicket.list')); ?>" class="btn btn-primary text-white"><i class="fas fa-list mr-2"></i>Lists</a>
                        </div>
                    </div>
                    <form id="prescription_ticket" action="<?php echo e(route('prescriptionTicket.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <?php if($doctors->count()>0): ?>
                                ...
                                <div class="row mx-1 mt-2" style="border: 1px solid #888;">
                                    ...
                                    <div class="col-md-4">
                                        <p class="pt-2"><span class="float-left font-weight-bold mr-2">Authorized By:</span> <span class=""><?php echo e(Auth::user()->name); ?></span></p>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="patient_age" id="patient_age" class="form-control" value="<?php echo e(old('patient_age')); ?>" placeholder="--" required="" min="0" max="99">
                                </div>
                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#search_doctor').on('keyup',function(){
            ...
            var action_url = "<?php echo e(route('prescriptionTicket.searchDoctor')); ?>";
            var value=$(this).val();
            var ticket_date = $('#ticket_date').val();
        ...
        $('#search_patient').on('keyup',function(){
            ...
            var action_url = "<?php echo e(route('prescriptionTicket.searchPatient')); ?>";
            var value=$(this).val();
            if(value.length >= '2'){
                $.ajax({
                    type : 'get',
        ...
        $('#search_person').on('keyup',function(){
            ...
            var action_url = "<?php echo e(route('prescriptionTicket.searchPerson')); ?>";
            var value=$(this).val();
            if(value.length >= '2'){
                $.ajax({
                    type : 'get',
        ...
        patient_form.on('submit', function(event){
            event.preventDefault()
            var url = '<?php echo e(route("prescriptionTicket.newPatient")); ?>'
            $.ajax({
                url:url,
                method: "POST",
                data: $(this).serialize(),
        ...
        user_form.on('submit', function(event){
            event.preventDefault()
            var url = '<?php echo e(route("prescriptionTicket.newBroker")); ?>'
            $.ajax({
                url:url,
                method: "POST",
                data: $(this).serialize(),
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\renaissa-hospital\resources\views/admin/pages/prescription_ticket/create.blade.php ENDPATH**/ ?>