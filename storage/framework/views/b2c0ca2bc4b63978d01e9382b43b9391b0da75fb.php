                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="pathology_department_name" name="pathology_department_name" class="form-control" placeholder="-----" required="">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="pathology_department_note" name="pathology_department_note" class="form-control" placeholder="-----">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
            ...
            <form id="update_form">
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="pathology_department_name">Pathology Department Name<span class="text-danger">&nbsp;*</span></label>
                            <input type="text" id="pathology_department_name" name="pathology_department_name" placeholder="-----" class="form-control" required="">
                            <div class="invalid-feedback">
                                Oh no!Pathology Department Name?
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="pathology_department_note">Pathology Department Note (Optional)</label>
                            <input type="text" id="pathology_department_note" name="pathology_department_note" placeholder="-----" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
